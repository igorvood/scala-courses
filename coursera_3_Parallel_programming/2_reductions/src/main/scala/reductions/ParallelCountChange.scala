...
object ParallelCountChange extends ParallelCountChangeInterface :
  ...
  def moneyThreshold(startingMoney: Int): Threshold = {
    def t(money: Int, coins: List[Int]): Boolean = {
      return startingMoney * 2 / 3 >= money
    }
  ...
  def totalCoinsThreshold(totalCoins: Int): Threshold = (money: Int, coins: List[Int]) => coins.size <= totalCoins * 2 / 3
